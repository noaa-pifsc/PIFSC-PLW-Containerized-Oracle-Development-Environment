# PIFSC Library Website Containerized Oracle Developer Environment

## Overview
The PIFSC Containerized Oracle Developer Environment (CODE) project was developed to provide a containerized Oracle development environment for PIFSC software developers. The PIFSC Library Website (PLW) was forked from the CODE project or a downstream forked CODE project to extend the CODE project's functionality and integrate PLW's dependencies. This repository can be forked to extend the existing functionality to any data systems that depend on the PLW for both development and testing purposes.

## Resources
-   ### Version Control Information
    -   URL: <https://github.com/noaa-pifsc/PIFSC-PLW-Containerized-Oracle-Development-Environment>
    -   Version: 1.1 (git tag: PLW_CODE_v1.1)
...
-   Custom Dependencies:
    -   ### PLW Version Control Information
        -   folder path: [/projects/PLW/modules/PLW](../../PLW/modules/PLW) 
        -   Version Control Information:
            -   URL: <git@github.com:noaa-pifsc/PIFSC-Library-Website.git>
            -   Application Version: 1.4 (Git tag: PIFSC_library_website_v1.4)
...
-   The PLW container application is available at the following URL by default: 
    ...
    -   \*Note: the port can be changed by updating CONTAINER_APP_PORT variable value in the [plw_runtime_config.sh](../config/plw_runtime_config.sh) configuration file
